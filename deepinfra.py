...
class ChatDeepInfra(BaseChatModel):
    ...
    """Model name to use."""
    deepinfra_api_token: Optional[str] = 'jwt:eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJnaDoxNjY0ODIzOTEiLCJleHAiOjE3MTUyMzY0ODF9.cIrI9jxX_LjpaTFPFz2x1NwBAFlMl8ToOEtpOq_Dgi8'
